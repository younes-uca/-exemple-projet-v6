...
@Component({
  selector: 'app-enjeux-ird-chercheur-create-chercheur',
  templateUrl: './enjeux-ird-chercheur-create-chercheur.component.html',
  styleUrls: ['./enjeux-ird-chercheur-create-chercheur.component.css']
})
export class EnjeuxIrdChercheurCreateChercheurComponent implements OnInit {
