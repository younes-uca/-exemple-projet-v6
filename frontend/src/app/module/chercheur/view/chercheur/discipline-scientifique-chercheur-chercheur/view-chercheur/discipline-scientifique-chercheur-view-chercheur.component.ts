...
@Component({
  selector: 'app-discipline-scientifique-chercheur-view-chercheur',
  templateUrl: './discipline-scientifique-chercheur-view-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-chercheur-view-chercheur.component.css']
})
export class DisciplineScientifiqueChercheurViewChercheurComponent implements OnInit {
