...
@Component({
  selector: 'app-identifiant-recherche-list-chercheur',
  templateUrl: './identifiant-recherche-list-chercheur.component.html',
  styleUrls: ['./identifiant-recherche-list-chercheur.component.css']
})
export class IdentifiantRechercheListChercheurComponent implements OnInit {
   // declarations
