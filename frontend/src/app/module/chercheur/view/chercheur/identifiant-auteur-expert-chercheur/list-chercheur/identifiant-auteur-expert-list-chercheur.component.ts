...
@Component({
  ...
  templateUrl: './identifiant-auteur-expert-list-chercheur.component.html',
  styleUrls: ['./identifiant-auteur-expert-list-chercheur.component.css']
})
export class IdentifiantAuteurExpertListChercheurComponent implements OnInit {
   // declarations
