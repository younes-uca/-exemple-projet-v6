...
@Component({
  selector: 'app-discipline-scientifique-erc-create-chercheur',
  templateUrl: './discipline-scientifique-erc-create-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-erc-create-chercheur.component.css']
})
export class DisciplineScientifiqueErcCreateChercheurComponent implements OnInit {
...
private _keyWordDisciplineScientifiqueErcsVo: Array<KeyWordDisciplineScientifiqueErcVo> = [];
...
ngOnInit(): void {
            ...
            this.keyWordService.findAll().subscribe(data => this.prepareKeyWordDisciplineScientifiqueErcs(data));
    ...
    this.disciplineScientifiqueErcParentService.findAll().subscribe((data) => this.disciplineScientifiqueErcParents = data);
         ...
         prepareKeyWordDisciplineScientifiqueErcs(keyWords: Array<KeyWordVo>): void{
        if( keyWords != null){
        keyWords.forEach(e => {
        const keyWordDisciplineScientifiqueErc = new KeyWordDisciplineScientifiqueErcVo();
        keyWordDisciplineScientifiqueErc.keyWordVo = e;
        this.keyWordDisciplineScientifiqueErcsVo.push(keyWordDisciplineScientifiqueErc);
        });
        }
    }
...
set disciplineScientifiqueErcs(value: Array<DisciplineScientifiqueErcVo>) {
 ...
 get selectedDisciplineScientifiqueErc(): DisciplineScientifiqueErcVo {
   ...
   get createDisciplineScientifiqueErcDialog(): boolean {
    ...
    get keyWordDisciplineScientifiqueErcsVo(): Array<KeyWordDisciplineScientifiqueErcVo> {
    if( this._keyWordDisciplineScientifiqueErcsVo == null )
    this._keyWordDisciplineScientifiqueErcsVo = new Array();
    return this._keyWordDisciplineScientifiqueErcsVo;
    }

    set keyWordDisciplineScientifiqueErcsVo(value: Array<KeyWordDisciplineScientifiqueErcVo>) {
    this._keyWordDisciplineScientifiqueErcsVo = value;
    }
