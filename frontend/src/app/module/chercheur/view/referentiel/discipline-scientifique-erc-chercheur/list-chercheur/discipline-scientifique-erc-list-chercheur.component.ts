...
@Component({
  selector: 'app-discipline-scientifique-erc-list-chercheur',
  templateUrl: './discipline-scientifique-erc-list-chercheur.component.html',
  styleUrls: ['./discipline-scientifique-erc-list-chercheur.component.css']
})
export class DisciplineScientifiqueErcListChercheurComponent implements OnInit {
   // declarations
