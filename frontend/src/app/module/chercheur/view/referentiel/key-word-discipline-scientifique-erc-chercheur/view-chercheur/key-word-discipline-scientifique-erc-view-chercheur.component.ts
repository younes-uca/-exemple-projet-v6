...
@Component({
  selector: 'app-key-word-discipline-scientifique-erc-view-chercheur',
  templateUrl: './key-word-discipline-scientifique-erc-view-chercheur.component.html',
  styleUrls: ['./key-word-discipline-scientifique-erc-view-chercheur.component.css']
})
export class KeyWordDisciplineScientifiqueErcViewChercheurComponent implements OnInit {
