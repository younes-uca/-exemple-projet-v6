...
@Component({
  selector: 'app-semantic-relationship-create-chercheur',
  templateUrl: './semantic-relationship-create-chercheur.component.html',
  styleUrls: ['./semantic-relationship-create-chercheur.component.css']
})
export class SemanticRelationshipCreateChercheurComponent implements OnInit {
