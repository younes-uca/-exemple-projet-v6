...
@Component({
  selector: 'app-semantic-relationship-edit-chercheur',
  templateUrl: './semantic-relationship-edit-chercheur.component.html',
  styleUrls: ['./semantic-relationship-edit-chercheur.component.css']
})
export class SemanticRelationshipEditChercheurComponent implements OnInit {
