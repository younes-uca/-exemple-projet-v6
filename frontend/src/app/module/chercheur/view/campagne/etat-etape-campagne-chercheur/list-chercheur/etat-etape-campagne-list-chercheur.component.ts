...
@Component({
  selector: 'app-etat-etape-campagne-list-chercheur',
  templateUrl: './etat-etape-campagne-list-chercheur.component.html',
  styleUrls: ['./etat-etape-campagne-list-chercheur.component.css']
})
export class EtatEtapeCampagneListChercheurComponent implements OnInit {
   // declarations
