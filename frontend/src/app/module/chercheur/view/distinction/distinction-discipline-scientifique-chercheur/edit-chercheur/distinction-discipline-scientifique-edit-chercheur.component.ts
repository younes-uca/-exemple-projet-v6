...
@Component({
  selector: 'app-distinction-discipline-scientifique-edit-chercheur',
  templateUrl: './distinction-discipline-scientifique-edit-chercheur.component.html',
  styleUrls: ['./distinction-discipline-scientifique-edit-chercheur.component.css']
})
export class DistinctionDisciplineScientifiqueEditChercheurComponent implements OnInit {
