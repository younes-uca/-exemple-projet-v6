...
@Component({
  ...
  styleUrls: ['./distinction-discipline-scientifique-create-chercheur.component.css']
})
export class DistinctionDisciplineScientifiqueCreateChercheurComponent implements OnInit {
