...
@Component({
  selector: 'app-etat-etape-campagne-view-admin',
  templateUrl: './etat-etape-campagne-view-admin.component.html',
  styleUrls: ['./etat-etape-campagne-view-admin.component.css']
})
export class EtatEtapeCampagneViewAdminComponent implements OnInit {
