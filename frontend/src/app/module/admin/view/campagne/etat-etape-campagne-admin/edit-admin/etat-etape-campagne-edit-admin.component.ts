...
@Component({
  selector: 'app-etat-etape-campagne-edit-admin',
  templateUrl: './etat-etape-campagne-edit-admin.component.html',
  styleUrls: ['./etat-etape-campagne-edit-admin.component.css']
})
export class EtatEtapeCampagneEditAdminComponent implements OnInit {
