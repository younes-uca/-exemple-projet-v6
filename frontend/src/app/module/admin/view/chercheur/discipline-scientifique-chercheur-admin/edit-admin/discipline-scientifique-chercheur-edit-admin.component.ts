...
@Component({
  selector: 'app-discipline-scientifique-chercheur-edit-admin',
  templateUrl: './discipline-scientifique-chercheur-edit-admin.component.html',
  styleUrls: ['./discipline-scientifique-chercheur-edit-admin.component.css']
})
export class DisciplineScientifiqueChercheurEditAdminComponent implements OnInit {
