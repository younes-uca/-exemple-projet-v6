...
@Component({
  ...
  templateUrl: './enjeux-ird-chercheur-view-admin.component.html',
  styleUrls: ['./enjeux-ird-chercheur-view-admin.component.css']
})
export class EnjeuxIrdChercheurViewAdminComponent implements OnInit {
