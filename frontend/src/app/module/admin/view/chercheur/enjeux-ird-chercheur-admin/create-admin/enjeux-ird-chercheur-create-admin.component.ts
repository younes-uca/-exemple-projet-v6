...
@Component({
  selector: 'app-enjeux-ird-chercheur-create-admin',
  templateUrl: './enjeux-ird-chercheur-create-admin.component.html',
  styleUrls: ['./enjeux-ird-chercheur-create-admin.component.css']
})
export class EnjeuxIrdChercheurCreateAdminComponent implements OnInit {
