...
@Component({
  selector: 'app-enjeux-ird-chercheur-edit-admin',
  templateUrl: './enjeux-ird-chercheur-edit-admin.component.html',
  styleUrls: ['./enjeux-ird-chercheur-edit-admin.component.css']
})
export class EnjeuxIrdChercheurEditAdminComponent implements OnInit {
