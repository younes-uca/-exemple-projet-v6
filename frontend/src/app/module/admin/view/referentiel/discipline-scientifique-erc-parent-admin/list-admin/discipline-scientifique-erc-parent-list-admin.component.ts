...
@Component({
  selector: 'app-discipline-scientifique-erc-parent-list-admin',
  templateUrl: './discipline-scientifique-erc-parent-list-admin.component.html',
  styleUrls: ['./discipline-scientifique-erc-parent-list-admin.component.css']
})
export class DisciplineScientifiqueErcParentListAdminComponent implements OnInit {
   // declarations
...
public async archiverDisciplineScientifiqueErcParent(disciplineScientifiqueErcParent: DisciplineScientifiqueErcParentVo){
const isPermistted = await this.roleService.isPermitted('DisciplineScientifiqueErcParent', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Discipline scientifique erc parent) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.disciplineScientifiqueErcParentService.archiver(disciplineScientifiqueErcParent).subscribe(status=>{
const myIndex = this.disciplineScientifiqueErcParents.indexOf(disciplineScientifiqueErcParent);
this.disciplineScientifiqueErcParents[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Discipline scientifique erc parent archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverDisciplineScientifiqueErcParent(disciplineScientifiqueErcParent: DisciplineScientifiqueErcParentVo){
const isPermistted = await this.roleService.isPermitted('DisciplineScientifiqueErcParent', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Discipline scientifique erc parent) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.disciplineScientifiqueErcParentService.desarchiver(disciplineScientifiqueErcParent).subscribe(status=>{
const myIndex = this.disciplineScientifiqueErcParents.indexOf(disciplineScientifiqueErcParent);
this.disciplineScientifiqueErcParents[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Discipline scientifique erc parent désarchivé',
life: 3000
});
},error=>console.log(error))
 }
