...
message: 'Voulez-vous archiver cet élément (Discipline scientifique) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.disciplineScientifiqueService.archiver(disciplineScientifique).subscribe(status=>{
const myIndex = this.disciplineScientifiques.indexOf(disciplineScientifique);
this.disciplineScientifiques[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Discipline scientifique archivé',
life: 3000
});
},error=>console.log(error))
 }
...
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Discipline scientifique) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.disciplineScientifiqueService.desarchiver(disciplineScientifique).subscribe(status=>{
const myIndex = this.disciplineScientifiques.indexOf(disciplineScientifique);
this.disciplineScientifiques[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Discipline scientifique désarchivé',
life: 3000
});
},error=>console.log(error))
 }
