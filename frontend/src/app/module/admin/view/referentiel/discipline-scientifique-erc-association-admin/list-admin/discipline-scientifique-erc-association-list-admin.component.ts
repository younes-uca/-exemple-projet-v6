...
@Component({
  ...
  templateUrl: './discipline-scientifique-erc-association-list-admin.component.html',
  styleUrls: ['./discipline-scientifique-erc-association-list-admin.component.css']
})
