...
@Component({
  ...
  templateUrl: './discipline-scientifique-erc-association-edit-admin.component.html',
  styleUrls: ['./discipline-scientifique-erc-association-edit-admin.component.css']
})
