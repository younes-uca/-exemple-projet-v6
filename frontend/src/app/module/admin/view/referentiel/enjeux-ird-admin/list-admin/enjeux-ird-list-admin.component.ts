...
public async archiverEnjeuxIrd(enjeuxIrd: EnjeuxIrdVo){
const isPermistted = await this.roleService.isPermitted('EnjeuxIrd', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Enjeux ird) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.enjeuxIrdService.archiver(enjeuxIrd).subscribe(status=>{
const myIndex = this.enjeuxIrds.indexOf(enjeuxIrd);
this.enjeuxIrds[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Enjeux ird archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverEnjeuxIrd(enjeuxIrd: EnjeuxIrdVo){
const isPermistted = await this.roleService.isPermitted('EnjeuxIrd', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Enjeux ird) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.enjeuxIrdService.desarchiver(enjeuxIrd).subscribe(status=>{
const myIndex = this.enjeuxIrds.indexOf(enjeuxIrd);
this.enjeuxIrds[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Enjeux ird désarchivé',
life: 3000
});
},error=>console.log(error))
 }
