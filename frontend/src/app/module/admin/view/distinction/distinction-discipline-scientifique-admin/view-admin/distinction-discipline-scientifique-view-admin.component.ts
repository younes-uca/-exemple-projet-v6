...
@Component({
  ...
  templateUrl: './distinction-discipline-scientifique-view-admin.component.html',
  styleUrls: ['./distinction-discipline-scientifique-view-admin.component.css']
})
export class DistinctionDisciplineScientifiqueViewAdminComponent implements OnInit {
