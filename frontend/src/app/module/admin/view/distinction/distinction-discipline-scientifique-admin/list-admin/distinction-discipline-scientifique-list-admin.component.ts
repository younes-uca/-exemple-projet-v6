...
@Component({
  selector: 'app-distinction-discipline-scientifique-list-admin',
  templateUrl: './distinction-discipline-scientifique-list-admin.component.html',
  styleUrls: ['./distinction-discipline-scientifique-list-admin.component.css']
})
export class DistinctionDisciplineScientifiqueListAdminComponent implements OnInit {
   // declarations
