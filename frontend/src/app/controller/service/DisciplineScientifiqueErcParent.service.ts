...
export class DisciplineScientifiqueErcParentService {
    ...
    public save(): Observable<DisciplineScientifiqueErcParentVo> {
        return this.http.post<DisciplineScientifiqueErcParentVo>(this.API, {
            ...this.selectedDisciplineScientifiqueErcParent,
            dateCreation: moment(this.selectedDisciplineScientifiqueErcParent.dateCreation).format('YYYY-MM-DD')
        });
    }
