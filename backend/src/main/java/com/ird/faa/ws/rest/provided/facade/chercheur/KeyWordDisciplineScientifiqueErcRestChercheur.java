...
public class KeyWordDisciplineScientifiqueErcRestChercheur {
    ...
    @ApiOperation("kharba9a")
    @GetMapping("/key/{id}")
    public String generateDisciplineScientifiqueErcLibelle(@PathVariable Long id) {
        return keyWordDisciplineScientifiqueErcService.generateDisciplineScientifiqueErcLibelle(id);
    }
