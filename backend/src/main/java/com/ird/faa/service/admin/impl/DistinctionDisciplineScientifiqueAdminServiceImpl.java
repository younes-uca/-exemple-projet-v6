...
@Service
public class DistinctionDisciplineScientifiqueAdminServiceImpl extends AbstractServiceImpl<DistinctionDisciplineScientifique> implements DistinctionDisciplineScientifiqueAdminService {
