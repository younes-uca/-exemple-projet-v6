...
public Chercheur findByIdWithAssociatedList(Long id){
    ...
    if(chercheur !=null && chercheur.getId() != null){
            List
            <List<DisciplineScientifiqueChercheur>> resultDisciplineScientifiqueChercheurs= disciplineScientifiqueChercheurService.getToBeSavedAndToBeDeleted(disciplineScientifiqueChercheurService.findByChercheurId(chercheur.getId()),chercheur.getDisciplineScientifiqueChercheurs());
