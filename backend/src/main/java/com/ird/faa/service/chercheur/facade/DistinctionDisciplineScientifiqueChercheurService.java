...
public interface DistinctionDisciplineScientifiqueChercheurService extends AbstractService<DistinctionDisciplineScientifique,Long,DistinctionDisciplineScientifiqueVo>{
